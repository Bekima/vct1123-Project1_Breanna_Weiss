//creates css link in head of document
addToHead = document.querySelector("head");
cssLink = document.createElement("link");
addToHead.appendChild(cssLink);
cssLink.setAttribute("rel","StyleSheet");
cssLink.setAttribute("href","css/style.css");
//creates a div with the class name div
wrapper = document.createElement("div");
wrapper.classList.add("wrapper");
bodY = document.querySelector("body");
bodY.appendChild(wrapper);
//creates 4 divs assighned the wrapperDivs class inside the div with the class Wrapper 
for (var i = 0; i < 4; i++) {
...
//color set up
color1 = "linear-gradient(135deg, #0B132B 0%, #3A506B 100%)";
color2 = "linear-gradient(330deg, #5BC0BE 0%, #3A506B 100%)";
color3 = "linear-gradient(35deg, #0B132B 0%, #5BC0BE 100%)";
color4 = "linear-gradient(235deg, #5BC0BE 0%, #3A506B 100%)";

colorsArray = [color1, color2, color3, color4];
console.log(colorsArray);
//Div Array set up
wrapper_Divs = document.getElementsByClassName("wrapperDivs");
console.log(wrapper_Divs);
//seperates divs
divOne = wrapper_Divs.item(0);
divTwo = wrapper_Divs.item(1);
divThree = wrapper_Divs.item(2);
divFour = wrapper_Divs.item(3);

for (var i = 0; i < 4; i++){
    allDivs = [divOne, divTwo, divThree, divFour];
    myDiv = allDivs[i];
